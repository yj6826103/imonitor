<template>
  <div class="spreadAnalyze" v-title="'搜索'">
    <!--顶部工具-->
    <Topbar></Topbar>
...
<script>
  ...
  export default {
    name: "detail-pages",
    components: {Topbar, Menu, Sidebar,TimeFrame, SearchListContent},
    data() {
      return {
        iM_options: {
          showMenu: false,
    ...
    created(){
      ...
      if(this.$route.query.searchTitle){
        this.headerData.push({path:'',name:this.$route.query.searchTitle})
      }
